...
let ChatMessageRepository = class ChatMessageRepository extends typeorm_1.Repository {
    constructor(chatMessageRepository) {
        super(chatMessageRepository.target, chatMessageRepository.manager, chatMessageRepository.queryRunner);
    }
};
...
//# sourceMappingURL=chat_message.repository.js.map