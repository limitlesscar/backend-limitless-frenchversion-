...
let HostRepository = class HostRepository extends typeorm_1.Repository {
    constructor(host) {
        super(host.target, host.manager, host.queryRunner);
    }
};
exports.HostRepository = HostRepository;
exports.HostRepository = HostRepository = __decorate([
    __param(0, (0, typeorm_2.InjectRepository)(host_entity_1.HostEntity)),
