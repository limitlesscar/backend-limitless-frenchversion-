...
let FcmTokenEntity = class FcmTokenEntity extends abstract_entity_1.AbstractEntity {
};
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.UserEntity, (user) => user.fcm_token, {
        onDelete: "SET NULL",
