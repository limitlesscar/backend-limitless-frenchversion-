...
const ws_guard_1 = require("../modules/core/auth/guards/ws.guard");
let SocketAuthMiddleware = class SocketAuthMiddleware {
    ...
    async use(client, next) {
        try {
            const wsJwtGuard = new ws_guard_1.WsJwtGuard(this.jwtService, this.configService);
...
//# sourceMappingURL=websockets.middleware.js.map